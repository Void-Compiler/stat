...
export default function ReportsPage() {
      ...
      setGenerationProgress((prev) => {
        if (prev >= 100) {
          ...
          const newReport: GeneratedReport = {
            ...
            title: reportTitle,
            template: selectedTemplateData?.name || "Statistical Summary Report",
            generatedAt: new Date().toISOString(),
            status: "completed",
            formats:
              selectedTemplateData?.format === "both" ? ["pdf", "html"] : [selectedTemplateData?.format || "pdf"],
  ...
  const handleDownloadReport = (reportId: string, format: "pdf" | "html") => {
    ...
    <head>
        ...
        <style>
            ...
            h1 { color: #10b981; }
            .header { border-bottom: 2px solid #10b981; padding-bottom: 10px; }
    ...
    <body>
        <div class="header">
            <h1>${report.title}</h1>
            <p>Generated by StatSense AI on ${formatDate(report.generatedAt)}</p>
        </div>
        <div class="section">
            <h2>Executive Summary</h2>
            <p>This report contains statistical analysis results generated from your uploaded data.</p>
        </div>
        <div class="section">
            <h2>Key Findings</h2>
            <ul>
                <li>Data processing completed successfully</li>
                <li>Statistical analysis performed with confidence intervals</li>
                <li>Trend analysis and distribution charts generated</li>
            </ul>
        </div>
    </body>
    </html>
    ...
    const blob = new Blob([reportContent], { type: format === "pdf" ? "application/pdf" : "text/html" })
